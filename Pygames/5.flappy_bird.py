...
while True:
    for event in pygame.event.get():
        ...
        if event.type==pygame.KEYDOWN:
            if event.key==pygame.K_SPACE and Flying==False and Game==True and flappy_bird.clicked==False:
                Flying=True
                flappy_bird.clicked=True
                flappy_bird.velocity=-5
        if event.type==pygame.KEYUP:
            if event.key==pygame.K_SPACE and flappy_bird.clicked==True:
